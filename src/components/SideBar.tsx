...
function SideBar() {
  return (
    <div className="grid grid-rows-[100px_1fr_1fr] grid-flow-col w-60 bg-projeto-secondary border-r border-projeto-border/70 h-screen">
      ...
      <nav className="flex flex-col gap-10 px-4 py-10 ">
